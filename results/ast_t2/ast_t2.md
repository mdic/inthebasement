---
title: "Apple Suckling Tree (Take 2)"
song_label: ast_t2
...
|:--------|:-------------------------------------------------------------|:---------------------------------|-------:|--------:|---------------:|:---------------|-----------:|----------------:|-----------------:|-------------------:|----------:|-----------:|------------:|--------------:|----------:|--------------------:|
| BS11    | 19 - Bob Dylan & The Band - Apple Suckling Tree (Take 2).wav | eb54c51d8282370f197a5b2208c62ab3 |      4 |      19 |        170.48  | 02:50:480      |   -17.5653 |        -18.0933 |         -16.6178 |           -1.47551 | 0.118156  |  0.111737  |   0.130063  |    -0.0183257 |  0.899458 |             2456.73 |
| CAR     | 04-19-Bob_Dylan-Apple_Suckling_Tree_Take_2-SMR.flac          | 9db05187c0da0c2e216c59a6659afa10 |      4 |      19 |        170.486 | 02:50:486      |   -17.5629 |        -18.0886 |         -16.6178 |           -1.47077 | 0.118146  |  0.111727  |   0.130052  |    -0.0183251 |  0.899458 |             2354.18 |
| ATWR    | 26 Apple Suckling Tree - Take 2.flac                         | 4589d23c5090af95767604e5bd637d4b |      4 |      26 |        167.08  | 02:47:080      |   -19.0991 |        -15.0739 |         -18.634  |            3.56013 | 0.100833  |  0.16251   |   0.0989185 |     0.0635918 |  0.133186 |             2700.2  |
| SBD     | 16 Apple Suckling Tree.flac                                  | dce8c79e6fb0b1e7fbf19eb2962a0790 |      2 |      16 |        168.347 | 02:48:347      |   -16.5288 |        -12.5105 |         -16.0636 |            3.55312 | 0.134748  |  0.217067  |   0.13225   |     0.0848171 |  0.134713 |             2714.78 |
| TGBT    | 2-07 Apple Suckling Tree (Version 2).flac                    | f1eafab6c3eb83538b284bb129ac4a6a |      2 |       7 |        171.333 | 02:51:333      |   -17.31   |        -13.7887 |         -15.9583 |            2.16967 | 0.121149  |  0.186032  |   0.132441  |     0.0535909 |  0.133331 |             2805.32 |
| CBST    | Dylan & Band - Safety Tape_Track16.flac                      | 3f372aa39f892d596a520f76e1c1eb92 |      1 |      16 |        166.52  | 02:46:520      |   -15.9789 |        -11.9584 |         -15.5052 |            3.54675 | 0.143778  |  0.231568  |   0.141143  |     0.0904247 |  0.135361 |             2574.73 |
| FTR     | 25. Apple Suckling Tree.flac                                 | 5d8ffe87e13863f1f89518d7169499b4 |     10 |      25 |        168.027 | 02:48:027      |   -18.5971 |        -20.3164 |         -16.5504 |           -3.76602 | 0.113262  |  0.0936394 |   0.139713  |    -0.0460741 |  0.890333 |             1389.57 |
| CB      | 25 Apple Suckling Tree - 5.flac                              | be06763718695f4b03a12746d60b2361 |      9 |      26 |        168.587 | 02:48:587      |   -19.6602 |        -21.3982 |         -17.6011 |           -3.79714 | 0.0991226 |  0.0824009 |   0.121412  |    -0.0390106 |  0.893234 |             1497.88 |

## Plots
![Waveforms (Mono)](ast_t2-waveforms_Mono.png)

![Waveforms (Left)](ast_t2-waveforms_L.png)

![Waveforms (Right)](ast_t2-waveforms_R.png)

![Radar Plot](ast_t2-radar_plot.png)

![MFCC Similarity](ast_t2-similarity_matrix.png)
...
![Pitch Offsets](ast_t2-pitch_offsets.png)
...
![Mel Spectrogram (Left)](ast_t2-BS11_melspec_L.png)

![Mel Spectrogram (Right)](ast_t2-BS11_melspec_R.png)

![Stereo Balance Bars](ast_t2-BS11_balance.png)

### CAR

![STFT Spectrogram (Left)](ast_t2-CAR_spectrogram_L.png)

![STFT Spectrogram (Right)](ast_t2-CAR_spectrogram_R.png)

![Mel Spectrogram (Left)](ast_t2-CAR_melspec_L.png)

![Mel Spectrogram (Right)](ast_t2-CAR_melspec_R.png)
...
![Mel Spectrogram (Left)](ast_t2-ATWR_melspec_L.png)

![Mel Spectrogram (Right)](ast_t2-ATWR_melspec_R.png)

![Stereo Balance Bars](ast_t2-ATWR_balance.png)

### SBD

![STFT Spectrogram (Left)](ast_t2-SBD_spectrogram_L.png)

![STFT Spectrogram (Right)](ast_t2-SBD_spectrogram_R.png)

![Mel Spectrogram (Left)](ast_t2-SBD_melspec_L.png)

![Mel Spectrogram (Right)](ast_t2-SBD_melspec_R.png)
...
![Mel Spectrogram (Left)](ast_t2-TGBT_melspec_L.png)

![Mel Spectrogram (Right)](ast_t2-TGBT_melspec_R.png)

![Stereo Balance Bars](ast_t2-TGBT_balance.png)

### CBST

![STFT Spectrogram (Left)](ast_t2-CBST_spectrogram_L.png)

![STFT Spectrogram (Right)](ast_t2-CBST_spectrogram_R.png)

![Mel Spectrogram (Left)](ast_t2-CBST_melspec_L.png)

![Mel Spectrogram (Right)](ast_t2-CBST_melspec_R.png)
...
![Mel Spectrogram (Left)](ast_t2-FTR_melspec_L.png)

![Mel Spectrogram (Right)](ast_t2-FTR_melspec_R.png)

![Stereo Balance Bars](ast_t2-FTR_balance.png)

### CB

![STFT Spectrogram (Left)](ast_t2-CB_spectrogram_L.png)

![STFT Spectrogram (Right)](ast_t2-CB_spectrogram_R.png)

![Mel Spectrogram (Left)](ast_t2-CB_melspec_L.png)

![Mel Spectrogram (Right)](ast_t2-CB_melspec_R.png)

![Stereo Balance Bars](ast_t2-CB_balance.png)
