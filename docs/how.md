...
If a file labelled `song_label.md` exists in the `notes` folder, its contents are added to the top of the final webpage, under the heading _Notes_.
...
1. **Preparation**
   ...
   - Assigns an [_album label_](albums/index.md) (e.g. `BS11`, `CAR`) based on the file path.
